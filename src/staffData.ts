...
export const STAFF_SUGESTOES: StaffSugestao[] = [
  {
    classe: "Billposter",
    acao: "Analisar diminishing returns no scaling de MP para o futuro",
  ...
  },
  {
    ...
    sugestao:
      "Nerf de 10~15% no dano base + reduzir o ratio 1,78× → ~1,5× (baixar o dano do 4º hit). O 4º hit continua sendo o mais forte, mas sem o pico exagerado.\n\nO problema não é a classe em si, mas o combo de sets joia + armas 5★. O ajuste mantém o Blade letal, mas com margem para o inimigo escapar.",
  },
  {
    classe: "Ranger",
    ...
    sugestao:
      "Reduzir o dano base em 10~15% e compensar atualizando o set Coelho — trocar a esquiva dos anéis por ADDOCH. Cada anel +20 daria +5% ADDOCH (total +10% com os dois anéis) o que seria de grande ajuda para novos players que ainda não possuem arma 5★.",
  },
  {
    classe: "Knight",
