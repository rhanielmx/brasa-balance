...
export const STAFF_SUGESTOES: StaffSugestao[] = [
  ...
  {
    classe: "Knight",
    acao: "Nerf de ~3~5% no HP",
    motivo: "HP muito alto — Knight 5★ não morre para BP Full FOR",
    prioridade: "Média",
    analise:
      "Knight está com muito HP — 307.8K com item de tank 3★, e com arma 5★ não morre para um Billposter Full FOR com os dados atuais. O dano baixo (82.1K) é intencional para não criar uma classe que tanka e mata todos facilmente, mas o HP atual está um pouco acima do ideal.",
    sugestao:
      "Nerf de ~3~5% no HP para trazer a classe a um patamar mais coerente.",
  },
  {
    classe: "Psykeeper",
