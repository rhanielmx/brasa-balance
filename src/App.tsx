...
import { StaffSuggestions } from "./components/StaffSuggestions"
...
function App() {
  ...
  const isStaff = location.pathname.startsWith("/sugestoes")
    ...
    <div className="page">
      <header className="header">
        <div className="header-text">
          <h1 className="title">
            {isStaff ? "Sugestões de Balanceamento" : "Brasa Balance"}
          </h1>
          <p className="subtitle">
            {isStaff
              ? "Análise e recomendações para a staff"
      ...
      <Routes>
        ...
        />
        <Route path="/pve" element={<PvEView />} />
        <Route path="/sugestoes" element={<StaffSuggestions />} />
      </Routes>
    </div>
  )
}
